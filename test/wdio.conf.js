exports.config = {
    ...
    //
    // First, you can define how many instances should be started at the same time. const's
    ...
    capabilities: [{
        ...
        // initiate internet_explorer
        /* myInternetExplorerBrowser: {
            desiredCapabilities: {
     ...
     * @param {Array.<Object>} capabilities list of capabilities details
     */
    // onCompconste: function(exitCode, config, capabilities) {
    // }
}
